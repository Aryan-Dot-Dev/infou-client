        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                href="https://www.linkedin.com/company/infouconsultancyservices/"
                target="_blank"
              ...
              {/* <a
                href="https://www.instagram.com/infouconsultancy"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* <a
                href="https://twitter.com/infouconsultancy"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Twitter"
                className="text-zinc-400 hover:text-black transition-colors duration-200"
          ...
          <div>
            ...
            <p className="text-zinc-500 font-sans text-sm leading-relaxed mb-6">
              81, 2nd Floor, B Block, Rajat Vihar<br />
              Sector 62, Noida, Uttar Pradesh, 201301<br />
              India
            </p>
            <p className="text-zinc-400 text-xs font-sans">
              © {new Date().getFullYear()} Infou Consultancy Services. All rights reserved.
            </p>
          </div>
        </div>
      </div>
