...
export default function Stepper({
  ...
  return (
    <div className="outer-container" {...rest}>
      <div className={`step-circle-container ${stepCircleContainerClassName}`} style={{ border: '1px solid #e4e4e7' }}>
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#f4f4f5', color: '#a1a1aa' },
          active: { scale: 1, backgroundColor: '#FF5A36', color: '#ffffff' },
          complete: { scale: 1, backgroundColor: '#FF5A36', color: '#ffffff' }
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: '#FF5A36' }
  };
