...
import serviceGrants from "../government_grant.jpg";
import serviceStartup from "../startup_scheme_matching.jpg";
import serviceLoan from "../bank_loan_support.jpg";
import serviceInvestor from "../investor_connect.jpg";
import serviceIncubation from "../incubation_access.jpg";
import servicePrivate from "../private_funding_access.jpg";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center w-full">
            ...
            <div className="col-span-1 lg:col-span-6 lg:order-2 text-center flex flex-col items-center justify-center">
              ...
              <h1 className="text-[32px] sm:text-[40px] md:text-5xl lg:text-[40px] xl:text-[48px] 2xl:text-6xl font-extrabold tracking-tight text-zinc-900 leading-[1.15] lg:leading-[1.1] text-center">
                ...
                <span className="block text-[#ea580c] notranslate mt-2 sm:mt-3">
                  <TextType
